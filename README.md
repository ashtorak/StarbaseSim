...
The StarbaseSimLibrary folder contains the C++ files from the Unreal Project. I don't know, if it will be of much use to anybody. Some parts might be hard to follow as half of the code is in the Blueprints. But other things like the tank farm and position controller are mostly C++. 
