// this is the ATP library with one function added by me
...
FVector UAsyncTickFunctions::ATP_AddForceAtPositionR(UPrimitiveComponent* Component, FVector Position, FVector Force,
	FName BoneName)
{
